...
public class FlightHandler1 implements Runnable{
    ...
    public FlightHandler1(FlightLog log, List<AirPort> airports,GridArea grid, JTextArea textArea, JLabel status){
        this.log = log;
